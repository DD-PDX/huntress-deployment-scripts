...
#
# Modified to make output on one line.
			echo "Bundle ID: $id - Status: $result"
...
out=$(parse_mdm_overrides)
if [[ $out != *"Bundle ID: com.huntress.sysext - Status: Approved"* ]]; then
	echo $out
    echo "False"
    exit
fi
